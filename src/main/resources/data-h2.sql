...
--init leave table
INSERT INTO LEAVES(ID, BEGIN, END, STYLIST_ID, LEAVE_TYPE) VALUES(SEQ_LEAVE_ID.NEXTVAL, '2018-08-07', '2018-08-10', SEQ_STYLIST_ID.CURRVAL, 'ON_HOLIDAY')
...
INSERT INTO RESERVATIONS(ID, TIME_INDEX, STYLIST_ID, CUSTOMER_ID, DATE) VALUES(SEQ_RESERVATION_ID.NEXTVAL, 0, 1, 1, '2018-08-06')
INSERT INTO RESERVATIONS(ID, TIME_INDEX, STYLIST_ID, CUSTOMER_ID, DATE) VALUES(SEQ_RESERVATION_ID.NEXTVAL, 1, 1, 2, '2018-08-06')
INSERT INTO RESERVATIONS(ID, TIME_INDEX, STYLIST_ID, CUSTOMER_ID, DATE) VALUES(SEQ_RESERVATION_ID.NEXTVAL, 1, 2, 1, '2018-08-06')
INSERT INTO RESERVATIONS(ID, TIME_INDEX, STYLIST_ID, CUSTOMER_ID, DATE) VALUES(SEQ_RESERVATION_ID.NEXTVAL, 2, 1, 2, '2018-08-06')
